...
project_structure = {
    ...
    "app/views/home": ["songcontainer.php", "playlistcontainer.php","upload.php","playlistcard.php"],
    "app/views/user": ["profile.php"],
    "app/views/playlist": ["playlistdisplay.php"],
    "app/views/layouts": ["navbar.php", "controllerbar.php"],
