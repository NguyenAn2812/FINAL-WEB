  ...
  <div class="bg-gray-800 p-6 rounded-lg w-[400px] text-white">
    ...
    <div id="choosePlaylistSection">
      <form id="addToPlaylistForm">
        ...
        <div class="mt-4 flex justify-between items-center">
          <button type="button" onclick="toggleCreatePlaylist(true)" class="text-sm text-blue-400 hover:underline">
            ➕ Tạo playlist mới
          </button>
    ...
    <div id="createPlaylistSection" class="hidden">
      <form id="createPlaylistForm" enctype="multipart/form-data">
        ...
        <input type="text" name="name" required class="w-full mb-4 p-2 rounded bg-gray-700 text-white text-sm">
        ...
        <div class="flex justify-between items-center mt-2">
          <button type="button" onclick="toggleCreatePlaylist(false)" class="text-sm text-gray-400 hover:underline">
            ⬅ Quay lại
          </button>
