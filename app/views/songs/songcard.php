<div class="w-[200px] md:w-[220px] lg:w-[240px] cursor-pointer transition transform hover:scale-105 hover:ring-2 hover:ring-blue-400/60 hover:shadow-xl relative rounded overflow-hidden">
